 ...
 * \file tvm/src/codegen/scop/codeanalys_scop.cc
 */
#include <iomanip>
#include <cctype>
#include <regex>
...
void CodeAnalysSCoP::Init() {
    ;
}

void CodeAnalysSCoP::InitFuncState(LoweredFunc f) {
  alloc_storage_scope_.clear();
  handle_data_type_.clear();
  map_arg_type_.clear();
  CodeGenSourceBase::ClearFuncState();
}
void CodeAnalysSCoP::AddFunction(LoweredFunc f) {
...
str2tupleMap<std::string, Type> CodeAnalysSCoP::Finish() {
  return this->map_arg_type_;
}

void CodeAnalysSCoP::PrintExpr(const Expr& n, std::ostream& os) {  // NOLINT(*)
  VisitExpr(n, os);
}

void CodeAnalysSCoP::PrintSSAAssign(
...
std::string CodeAnalysSCoP::GetBufferRef(
...
// Print a reference expression to a buffer.
std::string CodeAnalysSCoP::GetStructRef(
...
bool CodeAnalysSCoP::HandleTypeMatch(const Variable* buf_var, Type t) const {
  auto it = handle_data_type_.find(buf_var);
  if (it == handle_data_type_.end()) return false;
  return it->second == t;
}

void CodeAnalysSCoP::RegisterHandleType(const Variable* buf_var, Type t) {
  auto it = handle_data_type_.find(buf_var);
...
void CodeAnalysSCoP::PrintVecElemLoad(const std::string& vec,
                                Type t, int i,
                                std::ostream& os) {  // NOLINT(*)
  os << vec << ".s" << std::hex << i << std::dec;
}

void CodeAnalysSCoP::PrintVecElemStore(const std::string& vec,
                                 Type t, int i,
...
std::string CodeAnalysSCoP::GetVecLoad(
    Type t, const Variable* buffer, Expr base) {
  return GetBufferRef(t, buffer, base);
}

void CodeAnalysSCoP::PrintVecStore(const Variable* buffer,
                             Type t, Expr base,
                             const std::string& value) {
...
std::string CodeAnalysSCoP::CastFromTo(std::string value, Type from, Type target) {
...
void CodeAnalysSCoP::BindThreadIndex(const IterVar& iv) {
  LOG(FATAL) << "not implemented";
}

void CodeAnalysSCoP::PrintStorageSync(const Call* op) { // NOLINT(*)
}

void CodeAnalysSCoP::PrintStorageScope(const std::string& scope, std::ostream& os) { // NOLINT(*)
}

std::string CodeAnalysSCoP::GetType(Type t) { // NOLINT(*)
  std::ostringstream os;
  PrintType(t, os);
  return os.str();
}

void CodeAnalysSCoP::PrintType(Type t, std::ostream& os) {  // NOLINT(*)
  CHECK_EQ(t.lanes(), 1)
...
inline void PrintConst(const IntImm* op, std::ostream& os, CodeAnalysSCoP* p) { // NOLINT(*)
  if (op->type == Int(32)) {
...
inline void PrintConst(const UIntImm* op, std::ostream& os, CodeAnalysSCoP* p) { // NOLINT(*)
  if (op->type == UInt(32)) {
    std::ostringstream temp;
    temp << op->value << "U";
    p->MarkConst(temp.str());
...
inline void PrintConst(const FloatImm* op, std::ostream& os, CodeAnalysSCoP* p) { // NOLINT(*)
  switch (op->type.bits()) {
    case 64: case 32: {
      std::ostringstream temp;
...
void CodeAnalysSCoP::VisitExpr_(const IntImm *op, std::ostream& os) {  // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeAnalysSCoP::VisitExpr_(const UIntImm *op, std::ostream& os) {  // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeAnalysSCoP::VisitExpr_(const FloatImm *op, std::ostream& os) { // NOLINT(*)
  PrintConst(op, os, this);
}
void CodeAnalysSCoP::VisitExpr_(const StringImm *op, std::ostream& os) { // NOLINT(*)
  os << "\"" << op->value << "\"";
}
...
void CodeAnalysSCoP::VisitExpr_(const Cast *op, std::ostream& os) {  // NOLINT(*)
  std::stringstream value;
  this->PrintExpr(op->value, value);
  os << CastFromTo(value.str(), op->value.type(), op->type);
}
void CodeAnalysSCoP::VisitExpr_(const Variable *op, std::ostream& os) {  // NOLINT(*)
  os << GetVarID(op);
}
void CodeAnalysSCoP::VisitExpr_(const Add *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "+", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Sub *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "-", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Mul *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "*", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Div *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "/", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Mod *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "%", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Min *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "min", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Max *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "max", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const EQ *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "==", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const NE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "!=", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const LT *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "<", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const LE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "<=", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const GT *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, ">", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const GE *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, ">=", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const And *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "&&", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Or *op, std::ostream& os) {  // NOLINT(*)
  PrintBinaryExpr(op, "||", os, this);
}
void CodeAnalysSCoP::VisitExpr_(const Not *op, std::ostream& os) {  // NOLINT(*)
  os << '!';
  PrintExpr(op->a, os);
}

void CodeAnalysSCoP::VisitExpr_(const Call *op, std::ostream& os) {  // NOLINT(*)
...
void CodeAnalysSCoP::PrintVecBinaryOp(
...
void CodeAnalysSCoP::VisitExpr_(const Load* op, std::ostream& os) {  // NOLINT(*)
...
void CodeAnalysSCoP::VisitStmt_(const Store* op) {
...
void CodeAnalysSCoP::VisitExpr_(const Let* op, std::ostream& os) {  // NOLINT(*)
  std::string value = PrintExpr(op->value);
  CHECK(!var_idmap_.count(op->var.get()));
  var_idmap_[op->var.get()] = value;
}

void CodeAnalysSCoP::VisitExpr_(const Ramp* op, std::ostream& os) {  // NOLINT(*)
...
void CodeAnalysSCoP::VisitExpr_(const Broadcast* op, std::ostream& os) {   // NOLINT(*)
  LOG(FATAL) << "Broadcast: not supported ";
}

void CodeAnalysSCoP::VisitExpr_(const StreamExpr* op, std::ostream& os) {   // NOLINT(*)
}

void CodeAnalysSCoP::VisitExpr_(const Select* op, std::ostream& os) {  // NOLINT(*)
  os << "(";
...
void CodeAnalysSCoP::VisitExpr_(const GetBit *op, std::ostream& os) { // NOLINT(*)
  os << "(";
  PrintExpr(op->a, os);
  os << " & (1 << (";
...
void CodeAnalysSCoP::VisitExpr_(const GetSlice *op, std::ostream& os) { // NOLINT(*)
...
void CodeAnalysSCoP::VisitExpr_(const SetBit *op, std::ostream& os) { // NOLINT(*)
  os << "(";
  PrintExpr(op->a, os);
  os << " | (1 << (";
  PrintExpr(op->index, os);
...
void CodeAnalysSCoP::VisitExpr_(const SetSlice *op, std::ostream& os) { // NOLINT(*)
...
void CodeAnalysSCoP::VisitExpr_(const Quantize *op, std::ostream& os) { // NOLINT(*)
 LOG(FATAL) << "Quantize is not yet support";
}

void CodeAnalysSCoP::VisitExpr_(const KernelExpr *op, std::ostream& os) { // NOLINT(*)
}

void CodeAnalysSCoP::VisitStmt_(const LetStmt* op) {
  // TODO comaniac
...
void CodeAnalysSCoP::VisitStmt_(const Allocate* op) {
...
void CodeAnalysSCoP::VisitStmt_(const AttrStmt* op) {
...
void CodeAnalysSCoP::VisitStmt_(const AssertStmt* op) {
...
void CodeAnalysSCoP::VisitStmt_(const For* op) {
...
void CodeAnalysSCoP::VisitStmt_(const IfThenElse* op) {
  std::string cond = PrintExpr(op->condition);
  PrintIndent();
...
void CodeAnalysSCoP::VisitStmt_(const Block *op) {
  PrintStmt(op->first);
  if (op->rest.defined()) PrintStmt(op->rest);
}

void CodeAnalysSCoP::VisitStmt_(const Evaluate *op) {
...
void CodeAnalysSCoP::VisitStmt_(const ProducerConsumer *op) {
  PrintStmt(op->body);
}

void CodeAnalysSCoP::VisitStmt_(const KernelDef *op) {
}

void CodeAnalysSCoP::VisitStmt_(const KernelStmt *op) {
}

void CodeAnalysSCoP::VisitStmt_(const Return *op) {
  this->stream << "return ";
  PrintExpr(op->value);
  this->stream << ";\n";
}

void CodeAnalysSCoP::VisitStmt_(const Break *op) {
  // TODO: Check if the break statement is used correctly
  this->stream << "break;\n";
}

void CodeAnalysSCoP::VisitStmt_(const While *op) {
...
void CodeAnalysSCoP::VisitStmt_(const Reuse *op) {
  LOG(FATAL) << "KernelDef is not yet support";
}

void CodeAnalysSCoP::VisitStmt_(const Partition *op) {}

void CodeAnalysSCoP::VisitStmt_(const StreamStmt *op) {}

void CodeAnalysSCoP::VisitStmt_(const Stencil *op) {
  PrintStmt(op->body);
}
