 ...
 * \file codeanalys_scop.h
 * \brief AST analyzer for generating Static Control Part (SCoP) code.
 */
#ifndef TVM_CODEGEN_CODEANALYS_MERLINC_H_
#define TVM_CODEGEN_CODEANALYS_MERLINC_H_
...
/*!
 * \brief A class to analyze the IR AST for SCoP generation.
 *
 */
class CodeAnalysSCoP :
 ...
 public:
  ...
  /*!
   * \brief Print the Stmt n to CodeAnalysSCoP->stream
